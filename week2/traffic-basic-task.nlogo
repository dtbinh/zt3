globals [ sample-car ]
turtles-own [ speed speed-limit speed-min slow-time ]
...
to setup-road  ;; patch procedure
  if (pycor < 2) and (pycor > -2) [ set pcolor grey ]
end
...
to go
  ...
  ask turtles [
    ...
    ifelse speed < slow-speed-limit [
      set slow-time slow-time + 1
      set label slow-time
    ][
      set slow-time 0
      set label ""
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot sum [slow-time] of turtles"
